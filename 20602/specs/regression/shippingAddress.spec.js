...
describe('TEST SHIPPING ADDRESS TAB ELEMENTS', () => {
    ...
    it('TC-006-01 should verify "Full name" field is displayed', function() {
        expect(ShippingAddressPage.fullNameField.isDisplayed()).true;
    });
    ...
    it('TC-006-03 should verify "Country" dropdown is displayed', function() {
        expect(ShippingAddressPage.countryField.isDisplayed()).true;
    });

    it('TC-006-04 should verify "Country" dropdown has correct label', function() {
        expect(ShippingAddressPage.countryLabel.getText()).eq(expected.shippingAddressTab.countryLabell);
    });
    ...
    it('TC-006-08 should verify "Street address" field has correct placeholder', function() {
        expect(ShippingAddressPage.streetAddressField.getText()).eq(expected.shippingAddressTab.streetAddressPlaceholder);
    });
    ...
    it('TC-006-12 should verify "State/Province" field is displayed', function() {
        expect(ShippingAddressPage.stateProvinceField.isDisplayed()).true;
    });
